...
const SheetTrigger: React.FC<React.ComponentProps<typeof SheetPrimitive.Trigger>> = (props) => (
  <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />
)

const SheetClose: React.FC<React.ComponentProps<typeof SheetPrimitive.Close>> = (props) => (
  <SheetPrimitive.Close data-slot="sheet-close" {...props} />
)

const SheetPortal: React.FC<React.ComponentProps<typeof SheetPrimitive.Portal>> = (props) => (
