...
// A Filter is one axis of narrowing on a Filtered List. It owns its URL parser
...
// (server) or useQueryStates (client). loadFilteredList uses this internally;
// pages can also re-export the merged map for client components that pick a
// subset.
