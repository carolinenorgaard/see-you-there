...
- `keep users logged in across navigations on Vercel` — fixede to sammenhængende auth-bugs der kun ramte produktion (beskrevet under [03_arkitektur.md → Authentication](./03_arkitektur.md#authentication)).
